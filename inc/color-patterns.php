 ...
 */
function zdy_shopify_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filters zdy_shopify default saturation level.
	 *
	 * @since zdy_shopify 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'zdy_shopify_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.zdy_shopify-front-page) .entry-title,
...
.colors-custom .zdy_shopify-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.zdy_shopify-front-page .panel-content .recent-posts article,
...
.colors-custom.zdy_shopify-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters zdy_shopify custom colors CSS.
	 *
	 * @since zdy_shopify 1.0
	 *
	 ...
	 */
	return apply_filters( 'zdy_shopify_custom_colors_css', $css, $hue, $saturation );
}
